...
def run_code(registers, instructions):
    ...
    for instr in instructions:
        ...
        highest = max(highest, max(registers.values() if registers else DEFAULT_VALUE))
    return highest

def solve(data):
    registers = {}
    instructions = data.split('\n')
    highest = run_code(registers, instructions)
    print("Highest value in any register during process:", highest)
