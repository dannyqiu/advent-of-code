...
long eval_expression(const std::string& line) {
    // surround multiplicands by parenthesis to indicate addition precendence over multiplication
    // this requires the increasing the depth of existing parenthesis by 1 to maintain its precendence
