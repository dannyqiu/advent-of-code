...
function filterAunts(aunts, correctProperties) {
    ...
    for (aunt in aunts) {
        ...
        for (prop in aunts[aunt]) {
            // if cats or trees, must be greater than the correct property
            ...
            // if pomeranians or goldfish, must be less than the correct property
            ...
            // other properties cannot be differen from the correct property
            else if (aunts[aunt][prop] != correctProperties[prop]) {
                possible = false;
                break;
            }
        }
